 ...
 * (6-connectivity).
 * 
 * See mym_dilate26 for a similar function using a cube as structuring
...
void dilateR ( mxLogical *im1, const mxLogical *im0, const mwSize *size ) {
