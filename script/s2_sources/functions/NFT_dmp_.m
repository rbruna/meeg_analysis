...
% Finds the poligons connected to that poligon.
P2 = E ( E1, : );
E2 = find ( any ( ismember ( E, P2 ), 2 ) );

% Finds the normal of the element.
v1 = V ( E ( E2, 2 ), : ) - V ( E ( E2, 1 ), : );
v2 = V ( E ( E2, 3 ), : ) - V ( E ( E2, 2 ), : );
n  = cross ( v1, v2 );
n  = mean ( n );

% Checks if the point is in the direction of the normal or not.
% If the vector PPm (dot) Norm > 0 inside, < 0 outside.
in = dot ( Pm - P, n ) > 0;
